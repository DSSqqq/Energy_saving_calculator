...
class BuildingInputSerializer(serializers.Serializer):
    """Параметры одного здания для стен."""
...
class InvestmentItemSerializer(serializers.Serializer):
    """Строка сметы: количество в ед. изм. × цена за единицу."""
...
class WallsInputSerializer(serializers.Serializer):
    ...
    project_name = serializers.CharField(max_length=200, default="Энерго-аудит (Утепление стен)")
