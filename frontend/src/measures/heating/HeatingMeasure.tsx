/**
 * Корневой компонент мероприятия «Тепловые пункты».
 * Страница-заглушка — структура идентична «Окнам», наполнение будет добавлено позже.
 */

export function HeatingMeasure() {
  return (
    <main className="app">
      <header className="app__header">
        <h1><span className="title-icon">♨️</span>Мероприятие по теплоизоляции тепловых пунктов</h1>
      </header>
